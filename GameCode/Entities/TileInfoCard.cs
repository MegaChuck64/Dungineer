...
public class TileInfoCard : Entity
{
    ...
    public TileInfoCard(BaseGame game, Rectangle bounds, Texture2D texture, SpriteFont nameFont, SpriteFont infoFont, string name, string info) : base(game)
    {
        Bounds = bounds;
        Texture = texture;
        Name = name;
